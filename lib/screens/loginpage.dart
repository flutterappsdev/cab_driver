...
class _LoginPageState extends State<LoginPage> {
  ...
  void login() async {
    ...
    if(user!=null){
      ...
      final DatabaseReference ref = FirebaseDatabase.instance.reference().child('drivers/${user.user.uid}');
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    RoundButton('LOGIN', BrandColors.colorAccentPurple, () async {
                      final connResult =
              ...
              FlatButton(
                ...
                child: Text('Don\'t have an drive\'s account,sign up here.'),
              ),
            ],
          ),
        ),
