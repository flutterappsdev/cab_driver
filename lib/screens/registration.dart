...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  Future<void> register() async {
    ...
    if (authResult != null) {
      ...
      final DatabaseReference ref = FirebaseDatabase.instance.reference().child('drivers/${authResult.user.uid}');
      Map user = {
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    RoundButton('REGISTER', BrandColors.colorAccentPurple, () async{
              ...
              FlatButton(
                ...
                child: Text('Already have an Driver\'s account,Login.'),
              ),
            ],
          ),
        ),
