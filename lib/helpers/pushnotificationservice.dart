...
import '../widgets/notoficatiob_dialog.dart';
...
class PushNotificationService {
  ...
  Future<String> getToken() async {
    ...
    DatabaseReference tokenRef = FirebaseDatabase.instance
        .reference()
        .child('drivers/${FirebaseAuth.instance.currentUser.uid}/token');
    tokenRef.set(token);
  ...
  void fetchRideInfo(String rideID, context){
    ...
    showDialog(
      ...
      context: context,
      builder: ( context) => ProgressDialog('Fetching details',),
    );
    ...
    rideRef.once().then((DataSnapshot snapshot){
      ...
      if(snapshot.value != null){
        ...
        assetsAudioPlayer.open(
          Audio('assetes/sounds/alert.mp3'),
        );
